...
CREATE TABLE IF NOT EXISTS `mids`.`item_types` (
  ...
  `show_mileage` VARCHAR(1) NULL,
  `mileage_label` VARCHAR(80) NULL,
  `show_mot_date` VARCHAR(1) NULL,
  `mot_date_label` VARCHAR(80) NULL,
